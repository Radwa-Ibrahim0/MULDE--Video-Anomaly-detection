...
# Function to load ground truth data from .m files
def load_ground_truth(gt_file_path):
    # Load the .m file using scipy.io
    ...
    def load_ucsd_data(data_dir, train=True):
        ...
        for folder in sorted(os.listdir(path)):
            ...
            if os.path.isdir(folder_path):
                # Load ground truth only for test set
                ...
                for img_file in sorted(os.listdir(folder_path)):
                    if img_file.endswith('.tif'):
                        ...
                        try:
                            ...
                            # Assign labels: 0 for normal, 1 for anomaly (for test set)
                            if train:
